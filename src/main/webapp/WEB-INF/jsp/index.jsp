...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<div class="container-fluid">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link active" href="product/list">All product</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="category/withproduct">All Category AND Product</a></li>
			</ul>
		</div>
	</nav>
</body>
